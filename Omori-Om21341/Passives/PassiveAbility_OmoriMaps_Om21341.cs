...
{
    public class PassiveAbility_OmoriMaps_Om21341 : PassiveAbilityBase
    {
        private readonly CustomMapHandler _cmh = CustomMapHandler.GetCMU(OmoriModParameters.PackageId);
        private EnemyTeamStageManager_RushBattleWithCMUOnly_DLL4221 _em;
        ...
        public override void OnWaveStart()
        {
            if (Singleton<StageController>.Instance.EnemyStageManager is
                EnemyTeamStageManager_RushBattleWithCMUOnly_DLL4221 manager) _em = manager;
        ...
        {
            _em.SetMapPhase(_omoriPassive.GetSuccumbStatus() ? 4 : GetPhase());
            _em.OnRoundStart();
        }
